"""
Django settings for appkel project.
...
SECRET_KEY = 'django-insecure-wu@o=*5w_bj!l6&e%x^62j7xo=x4tw4tc#exquwcq6f@7($!7*'
...
WSGI_APPLICATION = 'appkel.wsgi.application'
